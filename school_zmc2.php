	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<h4 style='font-style: italic; font-size:16px; margin-top:1px;'>Heleen Bulthuis</h4><br>
				...
				<script>
					var datums = ["17-6-2018", "17-6-2018"];
					var files = ["pdf/ZMC 2.pdf", "pdf/ZMC 2 Extra.pdf"];
					var titles = ["Final Assignment - DISC", "ZMC 2 Extra Assignment"];
					var descs = ["", ""];
