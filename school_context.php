	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<h4 style='font-style: italic; font-size:14px; margin-top:1px;'>Tim Bosje</h4><br>
				...
				<script>
					var titles = ["News Dash", "Reference Research"];
					var datums = ["28-03-2018", "13-03-2018"];
					...
					for(i = 0; i < titles.length; i++)
					{
						...
						html += "<h4>Loes Banken, Noa van Bentem, Julia Emmink, Can Ur</h4>";
						...
						if(titles[i] == "News Dash")
						{
							var width = 320;
							var height = 200;
							for(l = 1; l < pics+1; l++)
							{	
								html += "<div class='LIobject' onclick='openIMG(this)' min-width:49%;><img src='images/context ("+l+").jpg' width='"+width+"' height='"+height+"' class='LIimage'/></div>";
							}
						}
						else if(titles[i] == "Reference Research")
						{
							var file = "pdf/Context_ReferenceResearch.pdf";
							
							html += "<object data='"+file+"' width='800' height='900'></object><br><br>";
								
							html += "<br><a style='margin-bottom:10px;' download href='"+file+"'><div class='download' style='width:150px;height:25px;margin:auto;'><div style='margin-top:-11px; padding-bottom:5px; padding-right: -2px; border-bottom: 3px solid #676767;'>Download <img src='images/Opslaan.png' width='30' height='30' style='margin-left:5px; margin-top:5px;'/></div></div></a><br><br>";
						}
