<?php
	...
	$page = "principlesinteractiondesign";
	$main_page = "school";
	$year = 1;
?>
	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<h4 style='font-style: italic; font-size:16px; margin-top:1px;'>Norbert van Geijn</h4><br>
				...
				<script>
					var datums = ["31-10-2017"];
					var files = ["pdf/UrCan_PoIxD_OnontworpenGebruik.pdf"];
					var titles = ["Unintended use"];
					var descs = ["An overview of 25 (5x5) examples of products that are used by methods they are not specifically designed for."];
