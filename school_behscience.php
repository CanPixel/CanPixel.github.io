...
<head>
<meta charset="utf-8">
<title>Behavioural Sciences</title>
	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<h4 style='font-style: italic; font-size:16px; margin-top:1px;'>Marilla Valente</h4><br>
				...
				<script>
					var datums = ["25-6-2018"];
					var files = ["pdf/Behavioral Science.pdf"];
					var titles = ["Motivation & Flow"];
					var descs = ["An essay about my experience with flow and motivation, in psychology terms."];
