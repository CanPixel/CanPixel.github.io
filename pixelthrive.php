	...
	<div style="float:left; width:73%; height:auto; margin-left:2.5%;">
		<section class="content">
			...
			<div style='width:80%; margin:auto;'>
				<h2 style='margin-bottom:10px;background-color:#999; padding:15px;'><b>2D Sandbox in Java</b></h2> <br>
				<div id='foto2'></div>
			</div><br><hr>
...
<b>PixelThrive</b> is an Open World game, taking influence from games such as Terraria. This project was made by me in collaboration with a few other people, among which a co-programmer and a texturer. The game was made in 2014. <br> <br><b>Features</b><br> Procedurally generated world.<br> 2D survival with a Crafting System.<br> A real-time shop with items being on sale at specific moments. <br>

<br> The game is completely written in Java from scratch, running its own 2D engine based on <a href="https://www.lwjgl.org/" class="link">LightWeight Java Game Library</a>.<br> <br>

<i style='font-size:18px;'>For one up to six players</i> <br> Multiplayer was planned, but hasn't been finished.<br> </p> <br>

<p style="width:800px; text-align:left; margin:auto; background-color:#999; padding:15px; color:#222; font-size:17px;">
<span id="info" class="anchorOffs"></span>
<b style="font-size:20px; background-color:#777; padding:5px;">Info</b> <br> <br> The game is a standalone .exe file for Windows (only). <br>
PixelThrive is made in Java. <br>All concepts, mechanics and stylistic choices are handmade by Pixelbolt Std. <br>(Small indie group of two programmers, a voice actor and a texture artist) <br>
	<br><b>For ages 12+</b><br> <i>Adult themes & crude humor.</i> <br> </p> <br>
...
<b style="font-size:20px; background-color:#777; padding:5px;">Controls</b> <br> <br> 'A' & 'D' to move, 'W' / Spacebar to jump. <br> </p>
<br> <hr> <br>
				
				<span class='titleCard'>Teaser trailer:</span><br>
				<iframe style='margin:5px; border:solid 4px #888; border-radius:10px; box-shadow: 5px 5px 15px #222;' width='840' height='480' src='https://www.youtube.com/embed/kr1d5OmIp70' frameborder='0' allowfullscreen></iframe> <br> <br> <hr> <br>
...
.LIimage:hover{transition: filter 0.4s ease; -webkit-transition: filter 0.4s ease; filter: contrast(90%) saturate(90%); cursor:zoom-in; border:solid 6px #444;} .LIobject:hover{border:solid 6px #555;}.LIobject:hover .LIoverlay{height: 15%; border:solid 6px #555;} .LIoverlay{border:none; position:absolute; bottom: 8px; left: 0; right: 0; background-color:#666; opacity:0.95; overflow:hidden; width: 94%; margin:auto; height: 0; transition: .5s ease; -webkit-transition: .5s ease;} .LIOverlaytext{white-space: nowrap; position: absolute; overflow:hidden; top: 50%; left: 50%; transform: translate(-50%, -50%);} .LIOverlaytext h4 {font-size:20px;}\
				...
				html += "\
				<div class='LIobject' onclick='openIMG(this)'><img class='LIimage' src='images/PixelThrive1.jpg' width='440' height='300'/><div class='LIoverlay'><div class='LIOverlaytext'><h4>Inventory & Crafting</h4></div></div></div>\
				<div class='LIobject' onclick='openIMG(this)'><img class='LIimage' src='images/PixelThrive2.jpg' width='440' height='300'/><div class='LIoverlay'><div class='LIOverlaytext'><h4>Creatures with Random Perks</h4></div></div></div> <br> <br> ";
				
				style.innerHTML += html;
				
				document.getElementById("foto2").innerHTML += "<div class='LIobject' onclick='openIMG(this)'><img class='LIimage' src='images/PixelThriveMenu.jpg' width='400' height='240'/></div>";
				</script>
...
- Weather
				...
				<div style="width:80%; margin:auto;"><b>The game is quite buggy, being one of the earliest projects of mine. <br>This was more of an experiment, than a project with a specific goal. <br> Therefore, I have learned a lot from this experimentation.<br></b></div> <br>
				</section>
				
				</div>
				<span id="download" class="anchorOffs"></span>
				<a download href="PixelThrive_12.jar"><div class="download" style="width:40%; height:80px; margin:auto;"><h2 style="font-size:28px;">Download PixelThrive</h2></div></a>
