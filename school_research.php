	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<script>
					var datums = ["28-09-2017", "2-10-2017", "17-10-2017", "22-10-2017"];
					var files = ["images/wireframe.jpg", "pdf/Research_Interview_Remco.pdf", "images/WireFramev2.jpg", "pdf/UrCan_Wireframe_v2.pdf:720:400"];
					var titles = ["Wireframe Website v1", "Interview with Remco", "Wireframe v2", "Wireframe v3"];
					var descs = ["First wireframe of my website (rough sketch):", "For the website (For the personas, go to <a href='school_toolsforthinking.php' class='link'>Tools for Thinking</a>) I interviewed Remco (In Dutch): ", "The second wireframe of my portfolio, according to Saffer's book.", "Second wireframe. School-page subtree."];
					...
					for(i = datums.length - 1; i >= 0; i--)
					{
						...
						var html = "<span class='anchorOffs' id='"+(titles[i].replace(/\s/g,''))+"'></span><h3 style='clear:both;'>" + titles[i] + "</h3><h4 style='float:right; margin-top:-75px;'>"+datums[i]+"</h4><p>" + descs[i] + "</p><br>";
