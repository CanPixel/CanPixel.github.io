	...
	<div style="float:left; max-width:73.8%; height:auto; margin-left:2.5%;">
		<section class="content">
			<div style="margin:5px -5px -5px 15px; background-color:#9F9F9F; padding: 5px 15px;">
				...
				<script>
					var datums = ["7-11-2017", "8-11-2017", "9-11-2017", "14-11-2017"];
					var files = ["pdf/DesignPosterTeam20.pdf:800:560", "pdf/UrCan_Storyboard_v1.pdf", "https://vimeo.com/242099739", "pdf/UrCan_CollabDesign_ZelfReflectie.pdf"];
					var titles = ["One Page Design Poster", "Storyboard", "Sci-Fi Concept Video", "Collaborative Design Reflection"];
					var descs = ["Sci-Fi Concept", "Storyboard Sci-Fi Concept", "Niels Weber, Matthew van Eenenaam, Ilja Ham, Gongjing Zheng, Can Ur", "Self reflection of my experience in this project (In Dutch)."];
...
.LIimage:hover{transition: filter 0.4s ease; -webkit-transition: filter 0.4s ease; filter: contrast(90%) saturate(90%); cursor:zoom-in; border:solid 6px #444;} .LIobject:hover{height: 20%; border:solid 6px #555;} </style>";
							...
							else if(file[0].startsWith("http"))
							{	
								html += "<iframe src='https://player.vimeo.com/video/242099739' width='1080' height='480' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> <br><br><p><a class='link' href='https://vimeo.com/242099739'>Power to the People - The Rise and Fall of the Direct Digital Democracy</a> from <a class='link' href='https://vimeo.com/user73990556'>Can Ur</a> on <a class='link' href='https://vimeo.com'>Vimeo</a>.</p>";
							}
